const CACHE_NAME='kajola-care-pwa-v3-brand';
const ASSETS=['/','/index.html','/manifest.webmanifest','/icons/icon-192.png','/icons/icon-512.png','/icons/kajola-mark.png','/icons/kajola-logo.png'];
